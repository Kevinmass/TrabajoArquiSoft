...
func init() {
	...
	DBPass := "omotcGBrKPpOIpySqaXCQaikFqubVISv" //password del root en la instalacion
	DBHost := "viaduct.proxy.rlwy.net"           //host de la base de datos. hbitualmente 127.0.0.1
	// ------------------------

	db, err = gorm.Open("mysql", DBUser+":"+DBPass+"@tcp("+DBHost+":56520)/"+DBName+"?charset=utf8&parseTime=True")
	// @:/railway
	if err != nil {
